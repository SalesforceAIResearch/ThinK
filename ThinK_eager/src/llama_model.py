    ...
    **kwargs,
    ...
    if past_key_value is not None:
        ...
        if key_states.shape[-2] == kv_seq_len:
            ...
            kv_pruned, kv_recent, mask, value_states_compress = self.kv_cluster.update_thinkv(key_states, query_states, value_states, attention_mask, self.num_key_value_groups)
